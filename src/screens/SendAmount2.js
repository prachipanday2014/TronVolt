...
const SendAmount2 = ({route, navigation}) => {
      ...
      <ScrollView>
        <View style={{flex: 1, justifyContent: 'space-between'}}>
          <View
            ...
            <Text style={{fontSize: textSize.p, fontFamily: fontName.NormalFont,}}>{strings.SelectAccountPara}</Text>
          </View>
          <View>
            <View
              style={{
            ...
            <View style={{marginVertical: 20}}>
              <Text style={[styles.label, {color: AppColors().borderColor}]}>
                {' '}
                {strings.To} :{' '}
              </Text>
              <View
                ...
                <TextInput
                  ...
                  placeholder={strings.SendAmount2Placeholder}
